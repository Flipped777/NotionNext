...
module.exports = {
  ...
  MUSIC_PLAYER_METING_ID:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '9320382542', // 对应歌单的 id
  MUSIC_PLAYER_METING_MINI:
    process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_MINI || false, // 对应歌单的 id
